...
\begin{longtable}[c]{|c|c|c|c|}
    \caption{ALMA Grid Search Parameters}
    \label{tab:alma_gridsearch_params}\\
    \hline
                       & \textbf{\begin{tabular}[c]{@{}c@{}}WINDOW\\ SIZE\end{tabular}} & \textbf{SIGMA}           & \textbf{OFFSET}                                                                 \\ \hline
    \endfirsthead
    %
    \multicolumn{4}{c}%
    ...
    \endhead
    %
    \textbf{FAST ALMA} & 1 to 10                                                        & \multirow{2}{*}{1 to 20} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}0.85, 0.90,\\ and 0.95\end{tabular}} \\ \cline{1-2}
    \textbf{SLOW ALMA} & 10 to 20                                                       &                          &                                                                                 \\ \hline
\end{longtable}
