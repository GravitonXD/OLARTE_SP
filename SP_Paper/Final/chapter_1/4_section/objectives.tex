...
\begin{itemize}
  ...
  \item[(d)] Finally, develop a mobile-based test application to showcase 
  the main functionalities of the developed RESTful API. Specifically which stocks
  to buy and to sell for a given period of time.
\end{itemize}