...
cpu_stats_preprocessor = [i for i in cpu_stats_preprocessor if i <= 100]
cpu_stats_alamAPI_API = [i for i in cpu_stats_alamAPI_API if i <= 100]
cpu_stats_alamAPI_DB = [i for i in cpu_stats_alamAPI_DB if i <= 100]
